...
console.log("88888888888888888888888",result);
  ...
  return (
      ...
      <Loader loading={loader} />
      <View
        style={{ ...GloableStyle.headerView3, backgroundColor: Color.greendark }}
      >
        {/* <TouchableOpacity
          onPress={() => {
            navigation.openDrawer();
...
<TouchableOpacity onPress={() => {
                ...
                <Text style={GloableStyle.backText1}>Back</Text>
            </TouchableOpacity>
              ...
              <View style={styles.flexcontainer}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={{ flex: 0.7 }}>
                    ...
                    {item.delivery_date != null ?   <Text style={GloableStyle.simpleText}>
                      {item.status == "Active" ? "Start from :" : "Order on :"}{" "}
                      {getLocalDate(item.delivery_date)}
                    </Text> : null }
