import { Dimensions, Image, Modal, SafeAreaView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native'
...
const Wallet = ({ navigation }) => {
    ...
    const renderModalVIew = () => {
        ...
        const icontext = isFailed ? "Sorry, Your Order has failed" : "Wallet Recharge Successfully..."
        const nxtText = isFailed ? "Sorry, somethings went wrong. Please try again to continue your order." : `We will update you Soon.`
    ...
    return (
        <SafeAreaView style={GloableStyle.container}>
            ...
            <View style={{ ...GloableStyle.rowtwoitem, justifyContent: 'space-between', marginVertical: horizScale(20) }}>
                <Text style={GloableStyle.headingText}>Current Wallet Balance</Text>
                <Text style={{ ...GloableStyle.headerText, color: Color.green1, marginRight: horizScale(20) }}>₹ 358</Text>
            </View>
